...
public enum ConfigurationKeys {
    ...
    // Network
    NETWORK_SSID_SINGLE_PLAYER("ssid_single_player", ConfigurationKeys.NETWORK),
    NETWORK_SSID_MULTI_PLAYER("ssid_multi_player", ConfigurationKeys.NETWORK),
    NETWORK_WIFI_MODE("wifi_mode", ConfigurationKeys.NETWORK),
    NETWORK_WIFI_RATE("wifi_rate", ConfigurationKeys.NETWORK),
    NETWORK_OWNER_MAC("owner_mac", ConfigurationKeys.NETWORK),

    // Miscs
    LED_ANIM("leds_anim", "leds"),
