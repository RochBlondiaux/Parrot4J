package me.rochblondiaux.parrot4j.api.drone.movements;
 ...
 */
@With
public record Location(double latitude, double longitude, double height) {

    public static final double EARTH_RADIUS = 6371000d; //meters

    public static double distance(Location l1, Location l2) {
        return distance(l1, l2.longitude, l2.latitude);
    }

    public static double distance(Location l1, double longitude2, double latitude2) {
        float[] res = computeDistanceAndBearing(l1.latitude(), latitude2, l1.longitude(), longitude2);
        return res[0];
    }
    ...
    public static float[] computeDistanceAndBearing(Location l1, Location l2) {
        return computeDistanceAndBearing(l1.latitude, l2.latitude, l1.longitude, l2.longitude);
    }
